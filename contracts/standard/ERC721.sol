 ...
 * {ERC721Enumerable}.
 */
contract HealingGems is MultiAuth, ERC165, IHealGems, IERC721Receiver, IERC721Metadata, IERC721Enumerable, AccessControl {
     ...
     */
    constructor() MultiAuth(payable(msg.sender)) {
        _name = 'Heal Angels';
        _symbol = "Heal Angels";
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = HealingGems.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(HealingGems.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(HealingGems.ownerOf(tokenId), to, tokenId);
    }
